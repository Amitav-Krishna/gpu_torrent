    ...
    try:
        ...
        while True:
            try:
                ...
                # The result from inference is already a dict, so we can just dump it
                await redis_client.set(result_key, json.dumps({"request_id": job_data['request_id'], "result": result}))
